...
class SnakeGame {
    ...
    setPlayerName(name) {
        ...
        this.updateHud(this.playerName
    ...
    setDirection(proposed) {
        if (proposed[0] === -this.direction[0] &&
    ...
    draw() {
        ...
        this.snake.forEach((segment, index) => {
            this.drawCell(segment, index === 0 ? COLORS.headFill : COLORS.bodyFill, index === 0 ? COLORS.headOutline : COLORS.bodyOutline);
        });
        if (this.gameOver) {
...
const canvas = getSnakeElement("game");
const scoreNode = getSnakeElement("score");
const messageNode = getSnakeElement("message");
const playerNameInput = getSnakeElement("player-name");
const saveNameButton = getSnakeElement("save-name");
const restartButton = getSnakeElement("restart");
const leaderboardNode = getSnakeElement("leaderboard");
const resetLeaderboardButton = getSnakeElement("reset-leaderboard");
const upButton = getSnakeElement("up");
const downButton = getSnakeElement("down");
const leftButton = getSnakeElement("left");
const rightButton = getSnakeElement("right");
const game = new SnakeGame(canvas, scoreNode, messageNode, leaderboardNode, playerNameInput);
